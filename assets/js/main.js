// إظهار/إخفاء تفاصيل المشروع عند الضغط على زر التفاصيل
document.addEventListener('DOMContentLoaded', function() {
  document.querySelectorAll('.project-card').forEach(function(card) {
    var desc = card.querySelector('.desc');
    if(desc) {
      // إضافة زر إظهار التفاصيل إذا لم يكن موجوداً
      if(!card.querySelector('.show-details-btn')) {
        ...
        btn.onclick = function(e) {
          ...
          btn.textContent = card.classList.contains('active') ? 'Hide Details' : 'Show Details';
        };
